...
/** The purpose of this class is to hold the contents of the result of an API call to /fill/[username]/{generations} */
public class FillResult {
    /** This variable is a String that describes the attributes added to the database.
     * Of the form "Successfully added X persons and Y events to the database". */
    ...
    public FillResult(String message, String errorMessage) {
